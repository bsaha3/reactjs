        ...
        return (
            <div>
                <table className="table">
                    ...
                    <Rows data={this.state.data} handleDelete={this.handleDelete} handleUpdate={this.handleUpdate} obj={this}/>
                </table>
                <nav>
                    <ul className="pager">
...
var Rows = React.createClass({
    render: function () {
        ...
        var rows = this.props.data.map(function (d, index) {
            return (
                <tr key={index}>
                    ...
                    <td>{d.email}</td>
                    <td>{d.phone}</td>
                    <td><button className="btn btn-info" onClick={this.props.handleUpdate}>Update</button></td>
                    <td><input type="button" value="Delete" className="btn btn-danger" onClick={this.props.handleDelete}/></td>
                </tr>
            );
        }.bind(this));
        return (
